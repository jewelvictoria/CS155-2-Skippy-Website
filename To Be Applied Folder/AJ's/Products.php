    ...
    <div class="category-row">
        <div class="c-column category1">
            <div class="category-content">
                ...
                <button class="category-btn cbtn1">Reserve Now</button>
            </div>
        </div>
        <div class="c-column category2">
            <div class="category-content">
                ...
                <p class="category-desc">Description</p>
                <button class="category-btn cbtn2">Reserve Now</button>
            </div>
        </div>
        <div class="c-column category3">
            <div class="category-content">
                ...
                <p class="category-desc">Description</p>
                <button class="category-btn cbtn3">Reserve Now</button>
            </div>
        </div>
    </div>
</div>
