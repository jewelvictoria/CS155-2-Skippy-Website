...
<body>
    ...
    <div class="main-section">
        <div class="tab">
            ...
            <button class="active" onclick="window.location.href = 'LoginAdmin.php';">Login as Admin</button>
...
<script language="javascript">
            function check(form) { /*function to check userid & password*/
                ...
                if(form.username.value == "admin" && form.pass.value == "skippy123") {
                    window.open('AdminReport.php',"_self") /*opens the target page while Id & password matches*/
                }
                else {
